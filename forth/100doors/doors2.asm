...
toggleEvery:	push dword ebp
	...
	;; ecx is every Nth door
	;; in this representation that is every 4 bytes is a single door
	;; so need multiply given door by 4
	;; and then increment using that amount
	mov dword ecx , [ebp + 8]
	mov dword eax , 4
	mul dword ecx
	mov dword ecx , eax
