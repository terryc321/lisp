...
;; identify the last thing we do , if it is a procedure call then we can translate that into a
;; jump instead of a regular C call.


;; define toplevel
;; define internal = letrecs 
;; sequence : begin
...
;; math operators : + - * / < > =
;; negation : not
;; type predicates : null? boolean? integer? number? complex? 
